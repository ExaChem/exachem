...
template<typename T>
class GFCCSD_IP_B_Driver {
public:
  // Rule of Five
  GFCCSD_IP_B_Driver()                                     = default;
  virtual ~GFCCSD_IP_B_Driver()                            = default;
  GFCCSD_IP_B_Driver(const GFCCSD_IP_B_Driver&)            = default;
  GFCCSD_IP_B_Driver& operator=(const GFCCSD_IP_B_Driver&) = default;
  GFCCSD_IP_B_Driver(GFCCSD_IP_B_Driver&&)                 = default;
  GFCCSD_IP_B_Driver& operator=(GFCCSD_IP_B_Driver&&)      = default;

  virtual void gfccsd_driver_ip_b(
